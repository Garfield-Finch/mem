...
def train(epoch, loader, model, optimizer, scheduler, device):
    ...
    for i, (_, _, img, pose) in enumerate(loader):
        ...
        if i % 200 == 0:
            torch.save(model.state_dict(), f'checkpoint/pose_06_black/vqvae_{str(epoch + 1).zfill(3)}.pt')
...
if __name__ == '__main__':
    ...
    for i in range(args.epoch):
        ...
        torch.save(model.state_dict(), f'checkpoint/pose_06_black/vqvae_{str(i + 1).zfill(3)}.pt')
