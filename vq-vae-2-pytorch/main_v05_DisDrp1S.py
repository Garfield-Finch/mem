...
and added drop out in tranfser net;
add weight for loss_GAN being 0.02 ;
"""
...
from tz_utils.networks_v04 import TransferModel, VQVAE, DiscriminatorModel
...
def train_transfer(epoch, loader, model_transfer, model_img, model_cond, model_D_t, model_D_b,
    ...
    for i, (img, pose) in enumerate(loader):
        ...
        loss = loss_quant_recon + loss_image_recon + weight_loss_GAN * loss_GAN
...
if __name__ == '__main__':
    ...
    viz.text(f'With a discriminator in latent space; '
             f'and added drop out in tranfser net; '
             f'add weight for loss_GAN being 0.02; '
             f'file: main_v05_DisDrp1S.py;\n '
    ...
    for i in range(args.epoch):
        viz.text(f'epoch: {i}', win='Epoch', title='Epoch')
