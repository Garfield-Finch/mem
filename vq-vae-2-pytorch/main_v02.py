    ...
    for i, (img, pose) in enumerate(loader):
        ...
        if i % 100 == 0:
            ...
            utils.save_image(
                ...
                img_show,
                f'sample/as_03/{str(epoch + 1).zfill(5)}_{str(i).zfill(5)}.png',
                nrow=sample_size,
                normalize=True,
                range=(-1, 1),
            )
        ...
        #########################
        if i % 200 == 0:
            torch.save(model_transfer.state_dict(), f'checkpoint/as_03/vqvae_{str(epoch + 1).zfill(3)}.pt')
...
if __name__ == '__main__':
    ...
    for i in range(args.epoch):
        ...
        torch.save(model_transfer.state_dict(), f'checkpoint/as_03/vqvae_{str(i + 1).zfill(3)}.pt')
