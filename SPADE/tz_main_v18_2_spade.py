"""
Use SPADE to decode
change z=None in tz_networks_v12_spade.py
"""
import argparse
import os
import visdom
...
from tz_networks_v12_1_spade import appVQVAE, VQVAE_SPADE, poseVQVAE, MultiscaleDiscriminator
...
if __name__ == '__main__':
    ...
    DESCRIPTION = """
        SPADE;Z=random;Seg=pose;Discriminator
    """\
                  f'file: tz_main_v18_2_spade.py;\n '\
