...
from tz_dataloader_v04_1_test import iPERLoader
...
if __name__ == '__main__':
    ...
    DESCRIPTION = """
        SPADE;Z=img_0;Seg=pose;without Discriminator;bigger data;test
    """\
                  f'file: tz_main_v18_2_5_spade.py;\n '\
    ...
    model.load_state_dict(torch.load('/p300/mem/mem_src/SPADE/checkpoint/as_82/vqvae_244.pt'))
    model.eval()
    print('Complete !')
