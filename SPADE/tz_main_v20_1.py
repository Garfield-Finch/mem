...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load('/p300/mem/mem_src/SPADE/checkpoint/as_121/vqvae_204.pt'))
    model.eval()
    print('Complete !')
    ...
    model_D.load_state_dict(torch.load('/p300/mem/mem_src/SPADE/checkpoint/as_121/vqvae_D_204.pt'))
    model_D.eval()
    print('Complete !')
