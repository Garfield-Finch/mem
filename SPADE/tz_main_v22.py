...
from tz_networks_v14_spade import appVQVAE, VQVAE_SPADE, poseVQVAE, MultiscaleDiscriminator
# from vq_vae_2_pytorch.scheduler import CycleScheduler
from tz_dataloader_v08 import iPERLoader
...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load('/p300/mem/mem_src/SPADE/checkpoint/as_115/vqvae_029.pt'))
    model.eval()
    print('Complete !')
