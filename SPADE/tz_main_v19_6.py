...
from tz_dataloader_v06_1 import iPERLoader
...
if __name__ == '__main__':
    ...
    model_D.load_state_dict(torch.load('/p300/mem/mem_src/SPADE/checkpoint/as_115/vqvae_D_028.pt'))
    model_D.eval()
    print('Complete !')
