...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load('/p300/mem/mem_src/SPADE/checkpoint/as_115/vqvae_010.pt'))
    model.eval()
    print('Complete !')
    ...
    # model_D.load_state_dict(torch.load('/p300/mem/mem_src/SPADE/checkpoint/as_115/vqvae_D_001.pt'))
    # model_D.eval()
    # print('Complete !')
